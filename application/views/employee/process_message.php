            ...
            <div class="content">
                ...
                <div class="panel panel-flat" id="ptn" style="overflow:auto;">
                    <table class="table  table-bordered datatable-basic">
                        ...
                        <tbody>
                        <?php $count=1;
                        foreach ($process_message as $messages) {
                            ?>
                            <tr>
                                <td><?=$count?></td>
                                <td><?=$messages->type_of_audit?></td>
                                <td><?=$messages->process_name?></td>
                                <td><?=$messages->lead_auditor_name?></td>
                                <td><?=$messages->frequency_name?></td>
                                <td><?=$messages->trigger_name?></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/Employee/show_process_message/<?=$messages->id?>" class="btn btn-primary">View</a>
                                </td>
                            </tr>
                            <?php $count++; } ?>
                        </tbody>
