										...
										<div class="col-md-6" >
											...
											<select name="audit_type" id="audit_type" class="form-control " onchange="getProcessData();">
												<?php foreach ($audit_type as $item) { ?>
													<option  value="<?=$item->type_id?>"><?=$item->type_of_audit?></option>
												<?php } ?>
											</select>
										</div>
										<div class="col-md-6">
										...
										<div class="col-lg-12">
											<div class="row">
												...
												<div class="col-md-4">
													...
													<div class="col-md-8">
														<select class="form-control" name="grade_nonconform" id="grade_nonconform" onchange="onChange_gradeOfNon()" required>
														</select>
													</div>
													<div class="col-md-4">
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-12">
													...
													<textarea class="form-control" id = "prob_desc" name="prob_desc" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
													...
													<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly'?> name="correction" required>TBD</textarea>
												</div>
												<div class="col-md-6">
											    	<span class="help-block">Grade of Non-conformity:</span>
													<textarea class="form-control" name="business_impact" id = "business_impact" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												...
												<div class="col-md-6">
													...
													<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly'?> name="root_cause" required>TBD</textarea>
													<input type="file" name="root_doc">
												</div>
												<div class="col-md-6">
											    	<span class="help-block">CORRECTIVE  ACTION PLAN:</span>
													<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly'?> name="action_plan" required>TBD</textarea>
											...
											<div class="row" style="margin-top: 24px;">
												...
												<div class="col-md-6">
													...
													<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly'?> name="corrective_action" required>TBD</textarea>
												  <input type="file" name="corrective_doc">
												</div>
												<div class="col-md-6">
											    	<span class="help-block">Verification of Effectiveness </span>
													<textarea class="form-control" id = "verification_effectiveness" name="verification_effectiveness" required>TBD</textarea>
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
											    	<span class="help-block">TYPE:</span>
												    	<select name="type" id = "type" onchange="OnChange_Type()" class="form-control " required>
												...
												<div class="col-md-6">
													...
													<input type="date" name="by_when_date" value="<?=date('Y-m-d', strtotime(date('Y-m-d')."+14 days"))?>" class="form-control" required>
												</div>
											</div>
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
											    	<span class="help-block">Process Owner:</span>
													    <select id="responsible_party" name="responsible_party" class="form-control" onchange="findresponsible(this.value);" required>
