...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="content">
                <form class="form-horizontal" method="post" action="<?php echo  base_url(); ?>index.php/Employee/select_process/<?=$pa_id?>" enctype="multipart/form-data" name="audit_plan_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <input readonly="" class="form-control daterange-single" value="" type="text" required name="open_when" value="<?= $is_plan ? $audit_plan_array['open_when'] : '' ?>"/>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="col-md-10">
                                            <?php if($is_schedule): ?>
                                                <a type="button" class="btn btn-primary btn-sm pull-right" href="<?php echo base_url(); ?>index.php/Employee/audit_schedule/<?=$pa_id?>">View Schedule</a>
                                            <?php else: ?>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <input readonly="" class="form-control daterange-single" value="" type="text" required name="close_when" id="close_when" value="<?= $is_plan ? $audit_plan_array['close_when'] : '' ?>" />
...
<div id="modal_theme_primary" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/Employee/add_employee_meeting" method="post" name="add_employee">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".datatable-header").append("<button type=\"button\" style='margin-right : 10px' class=\"btn btn-primary btn-sm pull-right\" onclick=\"add_employee_meeting();\">Add Employee</button>");
    });
    ...
    function get_open_employees(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/Employee/all_open_employees",
    ...
    function get_close_employees(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/Employee/all_close_employees",
...
//            $(".open_checker").prop("checked", false);
    ...
    function check_submit(state) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/Employee/checked_list",
            data:{'check_list' : employee_checked},
            success: function(data) {
                $("#modal_employee_sel").modal('hide');
                if(state == 'open') {
