    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <form action="<?php echo base_url();?>index.php/Employee/audit_schedule/<?=$pa_id?>" method="post" name="process_form">
                    <!-- Basic datatable -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="icons-list">
                                            ...
                                            <li class="text-danger-600"><a href="#" onclick="delete_process('<?=$process->process_id?>')" id="<?//=$employee->employee_id?>" class="delete" ><i class="icon-trash"></i></a></li>
                                        </ul>
                                    </td>
                                </tr>
                                <?php $count++; } ?>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="text-right">
                                            <a type="button" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/Employee/audit_plan/<?=$pa_id?>" style="margin-right: 40px;"><i class="icon-arrow-left16"></i> Back</a>
...
/****************Edit process Ajax*********************/
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/Employee/edit_single_process",
            data: {'pa_id': pa_id},
...
<div id="modal_theme_primary" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/Employee/add_process/<?=$pa_id?>" method="post" name="add_employee">
...
<div class="modal fade" id="modal_schedule_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url();?>index.php/Employee/del_process/?id=<?=$pa_id?>" method="post" name="add_employee">
    <div class="modal-content">  
      <div class="modal-header bg-primary">
...
<div id="modal_schedule_edit" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
           ...
           <form action="<?php echo base_url();?>index.php/Employee/update_process/?id=<?=$pa_id?>" method="post" name="add_employee">
            <?php
             /*echo "<pre>"; 
