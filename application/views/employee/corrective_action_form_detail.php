...
<tr>
	<td>Root cause:</td>
	<td><?=$standalone->root_cause?><button id = "btn_root_cause" type="button" onclick="show_root_cause()" class="btn btn-info btn-lg">Root Cause Analysis</button></td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id = "add_root_cause" action="<?php echo base_url();?>index.php/consultant/add_root_cause" method="post">
						<input type="hidden" name="data_id" value="<?=$standalone->id?>">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group has-feedback">
									...
									<textarea class="form-control" disabled id="conclusion" name="conclusion" rows="3"><?=$standalone->root_cause?></textarea>
								</div>
							</div>
						</div>
				</div>
