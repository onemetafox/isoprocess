            ...
            <!-- /page header -->
                <?php if($this->session->flashdata('message')=='success_del') { ?>
                    <div class="alert alert-styled-right alert-styled-custom alert-arrow-right alpha-teal alert-bordered">
                        ...
                        <span class="text-semibold"></span> Process Schedule Deleted Successfully...
                    </div>
                <?php  $this->session->unset_userdata('message'); } ?>

            <!-- Content area -->
            <div class="content">
                <form action="<?php echo base_url();?>index.php/Employee/audits_finish/<?=$pa_id?>" method="post" name="process_form">
                    <!-- Basic datatable -->
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="text-right">
                                            ...
                                            <a type="button" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/Employee/select_process/<?=$pa_id?>" style="margin-right: 20px;"><i class="icon-arrow-left16"></i> Back</a>
                                            <?php if (!$assign_flag): ?>
...
//****************************************//
    // $('#edit_auditor').attr('disabled',false);
     //$('#edit_auditor').prop('disabled',false);
     
    /*********************End***********************/

    function edit(val) {
        $('#modal_schedule_edit').modal('show');
       // $("#edit_auditor").css("pointer-events","none");
       // $("#edit_owner").css("pointer-events","none");
        $.ajax({
            type: "POST",
    ...
    function assign(val) {
       ...
       // $("#auditor").css("pointer-events","none");
       // $("#process_owner").css("pointer-events","none");
    }
...
<div id="modal_schedule_assign" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url(); ?>index.php/Employee/assign_process/<?=$pa_id?>" method="post">
...
<!----------Delete popup--------->
<!-- Modal HTML -->
<!-- <div id="modal_schedule_delete" class="modal fade">
...
<div class="modal fade" id="modal_schedule_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <form action="<?php echo base_url(); ?>index.php/Employee/delete_schedule_id/?id=<?=$pa_id?>" method="post">
    <div class="modal-content">
      <div class="modal-header bg-primary">
...
<div id="modal_schedule_edit" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url(); ?>index.php/Employee/edit_process/<?=$pa_id?>" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback">
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
  ...
  jQuery(document).on("click","#ms-list-2 button",function(){
