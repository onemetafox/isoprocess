                        ...
                        <table class="table table-lg table-bordered">
							...
							<tr>
                        	 ...
                        	 <tr>
                        	  ...
                        	  <tr>
                        	 	...
                        	 	<td>
                        	 		<select class="form-control" name="trigger_id" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="audit_criteria" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="grade_nonconform" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
							...
							<tr>
								...
								<td>
									<input type="date" class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> name="occur_date" value="<?=$standalone_data->occur_date?>" >
								</td>
							</tr>
                        	 ...
                        	 <tr>
                        	 	...
                        	 	<td>
									...
									<select class="form-control" name="customer_requirment" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
                        	 ...
                        	 <tr>
                        	 	...
                        	 	<td>
									<select class="form-control" name="product" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="process_step" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
                        	 ...
                        	 <tr>
                        	 	...
                        	 	<td>
									...
									<select class="form-control" name="standard" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="standard1" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
										<?php foreach ($standard_list as $item) { ?>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="standard2" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
										<?php foreach ($standard_list as $item) { ?>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="clause" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="clause1" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
										<?php foreach ($clause_list as $item) { ?>
							...
							<tr>
								...
								<td>
									...
									<select class="form-control" name="clause2" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
										<?php foreach ($clause_list as $item) { ?>
                        	  ...
                        	  <tr>
                        	 	...
                        	 	<td>
									<select class="form-control" name="regulatory_requirement" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
                        	  ...
                        	  <tr>
                        	 	...
                        	 	<td>
									<select class="form-control" name="policy" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
                        	  ...
                        	  <tr>
                        	 	...
                        	 	<td>
									...
									<select class="form-control" name="mashine_clause" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
                        	  ...
                        	  <tr>
                        	 	...
                        	 	<td>
									...
									<select class="form-control" name="shift" <?php if($user_type == 'Process Owner') echo 'disabled' ?>>
										<option>Not Applicable</option>
                        	   ...
                        	   <tr>
                        	 	...
                        	 	<td>
                        	 		<input type="text" class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> name="company_name" value="<?=$standalone_data->company_name?>" >
                        	 	</td>
                        	 </tr>
                        	 <tr>
                        	 	<td> 
                        	 	...
                        	 	<td>
                        	 		<input type="text" class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> name="company_address" value="<?=$standalone_data->company_address?>"  >
                        	 	</td>
                        	 </tr>
                        	  <tr>
                        	 	<td> 
                        	 	...
                        	 	<td>
                        	 		<input type="text" class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> value="<?=$standalone_data->city?>" name="city" >
                        	 	</td>
                        	 </tr>
                        	  <tr>
                        	 	<td> 
                        	 	...
                        	 	<td>
                        	 		<input type="text" class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> name="state" value="<?=$standalone_data->state?>" >
                        	 	</td>
                        	 </tr>
                        	 ...
                        	 <tr>
                        	 	...
                        	 	<td>
                        	 		<textarea class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> name="prob_desc"><?=$standalone_data->prob_desc?></textarea>
                        	 	</td>
                        	 </tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="form-control" <?php echo 'readonly' ?> name="ofi_desc"><?=$standalone_data->ofi_desc?></textarea>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="form-control" <?php echo 'readonly' ?> name="ofi"><?=$standalone_data->ofi?></textarea>
								</td>
							</tr>
                        	 <tr>
                        	 	<td> 
                        	 	...
                        	 	<td>
                        	 		<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly' ?> id="correction" name="correction"><?=$standalone_data->correction?></textarea>
                        	 	</td>
                        	 </tr>
                        	 ...
                        	 <tr>
                        	 	...
                        	 	<td>
                        	 		<textarea class="form-control" <?php if ($user_type == 'Process Owner') echo 'readonly' ?> id="business_impact" name="business_impact"><?=$standalone_data->business_impact?></textarea>
                        	 	</td>
                        	 </tr>
							<tr>
								<td>
									<span class="help-block" style="display: inline;padding-right: 40px;">ROOT CAUSE:</span>
<!--									<a data-toggle="modal" disabled data-target="#modal_root_cause" class="btn btn-info">Root Cause Analysis</a>-->
									<button id = "btn_root_cause" type="button" <?php if ($user_type != 'Process Owner') echo 'disabled'?>  class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_root_cause">Root Cause Analysis</button>
								</td>
								<td align="center">
								...
								<td>
									<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly' ?> id="root_cause" name="root_cause"><?=$standalone_data->root_cause?></textarea>
							...
							<tr style="display: none;">
								...
								<td>
									<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly' ?> id="breakdown" name="breakdown"><?=$standalone_data->breakdown?></textarea>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly' ?> id="action_plan" name="action_plan"><?=$standalone_data->action_plan?></textarea>
							...
							<tr>
								...
								<td>
									<textarea class="form-control" <?php if($user_type != 'Process Owner') echo 'readonly' ?> id="corrective_action" name="corrective_action"><?=$standalone_data->corrective_action?></textarea>
							...
							<tr>
								...
								<td>
									<textarea class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?> id="verification_effectiveness" name="verification_effectiveness"><?=$standalone_data->verification_effectiveness?></textarea>
                        	  ...
                        	  <tr>
                        	 	...
                        	 	<td>
									<?php $date = date('Y-m-d', strtotime($standalone_data->by_when_date."+14 days"));?>
                        	 		<input type="date" class="form-control" <?php if($user_type == 'Process Owner') echo 'readonly' ?>  name="by_when_date" value="<?=$standalone_data->by_when_date?>" >
                        	 	</td>
                        	 </tr>
                        	  <tr>
                        	 	<td> 
...
<script type="text/javascript">
	...
	function SetRootCause(){
		$("#root_cause").val($("#conclusion").val());
		$("#add_root_cause").submit();
	}
...
$('body').on('click','.savedata',function(e){
	...
	if($("#correction").val() == "TBD" || $("#correction").val() == ""){
		bootbox.alert("Please input CORRECTION field");
		return;
	}
	if($("#business_impact").val() == "TBD" || $("#business_impact").val() == ""){
		bootbox.alert("Please input Grade of Non-conformity field");
		return;
	}
	if($("#root_cause").val() == "TBD" || $("#root_cause").val() == ""){
		bootbox.alert("Please input ROOT CAUSE field");

		return;
	}
	if($("#action_plan").val() == "TBD" || $("#action_plan").val() == ""){
		bootbox.alert("Please input CORRECTIVE ACTION PLAN field");
		return;
	}
	if($("#corrective_action").val() == "TBD" || $("#corrective_action").val() == ""){
		bootbox.alert("Please input CORRECTIVE ACTION field");
		return;
	}

	if(($("#verification_effectiveness").val() == "TBD" || $("#verification_effectiveness").val() == "") && user_type != 'Process Owner'){
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" onclick="SetRootCause()" class="btn btn-primary"><i class="icon-reply role-right"></i> Save</button>
								</div>
								</form>
							</div>
						</div>
