        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default">
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>index.php/Welcome/employeedashboard"><i class="icon-home2 position-left"></i>Home</a></li>
                        <li><a href="#"><?=$title?></a></li> 
                    </ul>
                    <!-- <div class="notification_ic"><a href="#" onclick="updatelogin_noti('<?php echo $count_notification; ?>')" class="notif"><span class="num"><?php  echo $count_notification; ?></span></a></div> -->
...
<script type="text/javascript">
    function edit(val){
     ...
     function updatelogin_noti(val){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/Employee/update_notification",
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url();?>index.php/Employee/mails_to_indi" method="post">
