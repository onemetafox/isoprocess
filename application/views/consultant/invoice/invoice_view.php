			...
			<div class="content-wrapper">
				...
				<div class="content">
					<div class="panel panel-white" id="ptn">
						<form id="invoice_form" class="form-horizontal" action="<?php echo base_url('index.php/consultant/invoice_edit_action')?>" name="add_form" method="post">
...
<!-- 								<p class="text-muted text-center" style="font-size:14px">If you have any question about this invoice, please contact</p>
	...
	<form name="pdf_form"　style="display:none" action="<?php echo base_url('index.php/consultant/invoice_pdf')?>" method="post">
	...
	<script type="text/javascript">
		...
		function invoice_back(){
			location.href = "<?php echo base_url('index.php/consultant/invoice');?>";
		}
