										...
										<div class="col-lg-12">
											<div class="row">
												...
												<div class="col-md-4">
													...
													<div class="col-md-8">
														<select class="form-control" disabled name="grade_nonconform" id="grade_nonconform" required>
														</select>
													</div>
													<div class="col-md-4">
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
											    	<span class="help-block">COMPANY NAME:</span>
						                                ...
						                                <input type="text" disabled list="showlist" name="company_name" id="compt" class="form-control" oninput ="find(this.value);">
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-12">
													...
													<textarea class="form-control" disabled name="prob_desc" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-12">
													...
													<textarea class="form-control" disabled name="ofi_desc" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-12">
													...
													<textarea class="form-control" disabled name="ofi" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
													...
													<textarea class="form-control" disabled name="correction" required>TBD</textarea>
												</div>
												<div class="col-md-6">
											    	<span class="help-block">Grade of Non-conformity:</span>
													<textarea class="form-control" disabled name="business_impact" required></textarea>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 24px;">
												...
												<div class="col-md-6">
													...
													<textarea class="form-control" disabled name="root_cause" required>TBD</textarea>
													<input type="file" disabled name="root_doc">
												</div>
												<div class="col-md-6">
											    	<span class="help-block">CORRECTIVE  ACTION PLAN:</span>
													<textarea class="form-control" disabled name="action_plan" required>TBD</textarea>
											...
											<div class="row" style="margin-top: 24px;">
												...
												<div class="col-md-6">
													...
													<textarea class="form-control" disabled name="corrective_action" required>TBD</textarea>
												  <input type="file" disabled name="corrective_doc">
												</div>
												<div class="col-md-6">
											    	<span class="help-block">Verification of Effectiveness </span>
													<textarea class="form-control" disabled name="verification_effectiveness" required>TBD</textarea>
											...
											<div class="row" style="margin-top: 24px;">
												...
												<div class="col-md-6">
													...
													<input type="date" disabled name="by_when_date" value="<?=date('Y-m-d')?>" class="form-control" required>
												</div>
											</div>
											<div class="row" style="margin-top: 24px;">
												<div class="col-md-6">
