...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="content">
                <form class="form-horizontal" method="post" action="<?php echo  base_url(); ?>index.php/Consultant/open_audit" enctype="multipart/form-data" name="byaudit_form">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="form-group col-md-6">
                                <label style="margin-left:15px">Date Range: </label>
                    ...
                    <table class="table datatable-basic">
                        ...
                        foreach ($open_audits as $audit) { ?>
                            <tr>
                                ...
                                <td><?= $audit->type ?></td>
                                <td>
                                    <a type="button" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/Consultant/edit_audit_plan/<?=$audit->log_id?>">AUDIT</a>
                                    <a type="button" class="btn btn-primary btn-sm" onclick="deleteAudit(<?=$audit->log_id?>)" >DELETE</a>
                                    <a type="button" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/Consultant/clone_audit/<?=$audit->log_id?>">
            ...
            buttons: {
                ...
                ok: {
                    ...
                    callback: function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>index.php/Consultant/delete_audit_plan/"+val,
