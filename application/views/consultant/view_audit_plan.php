        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="panel" style="min-height: 60px;">
                    ...
                    <div style="height: 80%;padding-left: 86%;">
                        <a type="button" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/Consultant/audit_brief/<?=$audit_id?>">Edit Audit</a>
                        &nbsp;
                    </div>
                    <div style="min-height: 10px;height: 10%;"></div>
                </div>
...
//    console.clear();
    function check_close_audit(){
        ...
        location.href = "<?php echo base_url(); ?>index.php/Consultant/close_audit_plan/<?=$audit_id?>";
    }
    function redirect_map(id,map_type){
        if (map_type == 1){
            location.href = "<?php echo base_url(); ?>index.php/Consultant/edit_checklist_mind/"+id;
        }
        if (map_type == 2){
            location.href = "<?php echo base_url(); ?>index.php/Consultant/edit_checklist_process/"+id;
        }
    }
    function redirect_view_map(id,map_type){
        if (map_type == 1){
            location.href = "<?php echo base_url(); ?>index.php/Consultant/view_checklist_mind/"+id;
        }
        if (map_type == 2){
            location.href = "<?php echo base_url(); ?>index.php/Consultant/view_checklist_process/"+id;
        }
        if (map_type == 0){
            var dialog = bootbox.dialog({
                title: 'Warning',
