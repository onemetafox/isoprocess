...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <form id="get_checklist" action="<?php echo base_url(); ?>index.php/Consultant/get_checklist_mind" method="post">
                <input type="hidden" id = "process_id" name="process_id" value = "<?=$process_id?>">
            ...
            <div class="content">
                ...
                <div class="panel" style="min-height: 60px;">
                    ...
                    <div style="height: 100%;padding-left: 1%;padding-right: 1%;">
                            ...
                            foreach ($checklist as $checklist) { ?>
                                <tr>
                                    ...
                                    <td style="width: 19%;">
                                        ...
                                        <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$checklist->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
                                        <?php endif; ?>
                                        ...
                                        <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/resolution/<?=$checklist->corrective_id?>" class="btn btn-primary btn-sm">Log</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php
