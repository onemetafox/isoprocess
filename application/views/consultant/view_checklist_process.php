                                ...
                                <tr>
                                    ...
                                    <td style="width: 19%;">
                                        <?php if ($input_step->status != 'NO ISSUE'): ?>
                                            <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$input_step->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
                                        <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($activity->status != 'NO ISSUE'): ?>
                                            <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$activity->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
                                        <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 19%;">
                                        <?php if ($output->status != 'NO ISSUE'): ?>
                                            <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$output->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
                                        <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 19%;">
                                        <?php if ($control->status != 'NO ISSUE'): ?>
                                            <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$control->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
                                        <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 19%;">
                                        <?php if ($resource->status != 'NO ISSUE'): ?>
                                            <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$resource->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
                                        <?php endif; ?>
                        ...
                        <table class="table">
                            ...
                            foreach ($effectiveness as $effectiveness) { ?>
                                <tr>
                                    ...
                                    <td style="width: 19%;">
                                        <a type="button" href = "<?php echo base_url(); ?>index.php/Consultant/corrective_action_form/<?=$effectiveness->checklist_id?>" class="btn btn-primary btn-sm">Load</a>
