	...
	<div class="page-container">
		...
		<div class="page-content">
            ...
            <!-- /page header -->
    			...
    			<form class="form-horizontal" method="post" action="<?php echo  base_url(); ?>index.php/Consultant/byauditee" enctype="multipart/form-data" name="byaudit_form">
              <div class="panel panel-body  text-left" style="padding-bottom: 0px;">
                <div class="col-md-11">
                  ...
                  <th>CORRECTIVE</th>
							...
							<tbody>
								<?php $count=1;
                foreach ($byauditee_data as $byauditee_data) { ?>
  								<tr style="background:#0097a7">
  								  <td><?php echo $count?></td>
                    <td><?php echo $byauditee_data->employee_name?></td>
                    <td><?php echo $byauditee_data->noncomformity?></td>
                    <td><?php if (isset($byauditee_data->ofi)) echo $byauditee_data->ofi; else echo '';?></td>
                    <td><?php if (isset($byauditee_data->corrective)) echo $byauditee_data->corrective; else echo '';?></td>
  								</tr>
								<?php $count++; } ?>
							</tbody>
						</table>
...
<script type="text/javascript">
  ...
  $('#detail_btn').click(function(){
        location.href="<?php echo base_url('index.php/Consultant/statistic/3')?>"
  });
