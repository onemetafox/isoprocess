	...
	<div class="page-container">
        ...
        <!-- /page header -->
				...
				<div class="content">
  				...
  				<form class="form-horizontal" method="post" action="<?php echo  base_url(); ?>index.php/Consultant/byprocess" enctype="multipart/form-data" name="byaudit_form">
            <div class="panel panel-body  text-left" style="padding-bottom: 0px;">
              <div class="col-md-12">
                  ...
                  <th>NON-CONFORMITY</th>
							...
							<tbody>
								<?php $count=1;
                  foreach ($byprocess_data as $byprocess) { ?>
    								<tr style="background:#0097a7">
    								    <td><?php echo $count?></td>
    								    <td><?php echo $byprocess->process_name?></td>
                        <td><?php echo $byprocess->noncomformity?></td>
                        <td><?php if (isset($byprocess->ofi)) echo $byprocess->ofi; else echo '';?></td>
                        <td><?php if (isset($byprocess->corrective)) echo $byprocess->corrective; else echo '';?></td>
    								</tr>
								  <?php $count++; } ?>
							</tbody>
						</table>
  ...
  $('body').on('click','.delete' ,function(e){
    ...
    buttons: {
        ...
        ok: {
            ...
            callback: function(){
               window.location.href="<?php echo base_url();?>index.php/consultant/delete_byprocessform/"+id;
            }
        }
     }
    });
...
<script type="text/javascript">
  ...
  $('#detail_btn').click(function(){
        location.href="<?php echo base_url('index.php/Consultant/statistic/1')?>"
  });
