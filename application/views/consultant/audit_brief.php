                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-md-6" style="margin-top: 10px;">
                                                ...
                                                <input type="hidden" name="refer_num" value="<?=($is_brief=='1') ? $audit_brief_array->refer_num : time()?>">
                                            </div>
                                            <div class="col-md-4">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="" class="form-control" name="audit_of" id="audit_of" required value="<?= ($is_brief=='1') ? $audit_brief_array->audit_of : '' ?>">
                                        ...
                                        <div class="row" style="margin-top: 24px;">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="" class="form-control" name="locations" id="locations" required value="<?= ($is_brief=='1') ? $audit_brief_array->locations : '' ?>">
                                         ...
                                         <div class="row" style="margin-top: 24px;">
                                            <div class="col-md-12">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea placeholder="" class="form-control" name="summary" id="summary" required><?= ($is_brief=='1') ? $audit_brief_array->summary : '' ?></textarea>
                                        ...
                                        <div class="row" style="margin-top: 24px;">
                                            <div class="col-md-12">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea placeholder="" class="form-control" name="purpose" id="purpose" required><?= ($is_brief=='1') ? $audit_brief_array->purpose : '' ?></textarea>
                                        ...
                                        <div class="row" style="margin-top: 24px;">
                                            <div class="col-md-12">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea placeholder="" class="form-control" name="context" id="context" required><?= ($is_brief=='1') ? $audit_brief_array->context : '' ?></textarea>
                                        ...
                                        <div class="row" style="margin-top: 24px;">
                                            <div class="col-md-12">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea placeholder="" class="form-control" name="scope" id="scope" style="min-height: 100px;" required><?= ($is_brief=='1') ? $audit_brief_array->scope : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 24px;">
                                            <div class="col-md-12">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea placeholder="" class="form-control" name="criteria" id="criteria" required><?= ($is_brief=='1') ? $audit_brief_array->criteria : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 24px;">
                                            <div class="col-md-12">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea placeholder="" class="form-control" name="objectives" id="objectives" required><?= ($is_brief=='1') ? $audit_brief_array->objectives : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 24px;">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-10">
                                                            <div class="panel panel-flat" style="overflow: auto;">
                                                                <table class="table datatable-basic" id="auditor__view" style="font-size: 13px;">
                                                                    <thead>
                                                                    <tr>
                                                                        <th>No</th>
                                                                        <th>Select</th>
